#!/usr/bin/env python3
r"""OP4 M1 quadruplet match: P0 -> chicane entrance (P1).
...
adopted horizontal design choice:
  ...
  y   the analytic edge-focusing matched solution of the chicane,
      `thzim.chicane.matched_y` with lead = 0.2 m, evaluated at OP4's chicane
...
distribution is written to `outputs/OP4/beams/p1.ast`.
...
def main():
    ...
    apply_style()
    save(figure_e2e(match, tws, SC), FIGS, 'fig_OP4_m1_quadruplet_match')
    plt.show()

#!/usr/bin/env python3
r"""OP3 M3 quadruplet match: chicane exit (P2) -> undulator entrance (P3).
...
(2.58, 0, 0.07, 0), a vertical waist of 70 mm at the undulator entrance. There
is no derivation script for it.
...
`outputs/OP3/beams/p3.ast` for the FEL stage, and its longitudinal summary
(peak current, bunch length, energy spread) is printed for the Genesis4 input.

Input:  `outputs/OP3/beams/p2.ast` (from `chicane_track.py`)
Output: `outputs/OP3/beams/p3.ast`
...
def main():
    ...
    apply_style()
    save(figure_e2e(match, tws, SC), FIGS, 'fig_OP3_m3_quadruplet_match')
    plt.show()
